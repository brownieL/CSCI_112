...
import order_profile as order
from decimal import Decimal
import randomdate as randomdate

"""
This module adds data to the table.
"""
...
if __name__ == '__main__':
    ...
    order.checkout("aarchamb", "home", shopping_cart1, randomdate.randomizer_date())
    order.checkout("tgrimes1", "home", shopping_cart2, randomdate.randomizer_date())
    order.checkout("tgrimes1", "home", shopping_cart3, randomdate.randomizer_date())